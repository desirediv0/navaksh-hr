...
export default function AnimatedButton({
  ...
  const base =
    "relative inline-flex items-center justify-center font-black tracking-[0.1em] uppercase overflow-hidden transition-all duration-300 group select-none rounded-xl";
